...
class Stack(object):
    ...
    def empty(self):
        ...
        # I do see later in the exercises (in the queue.py file) that the usual
        # usage of this type of function would be to return the values in the list
        # when you empty it, but didn't seem that that was what this was asking.
        # if you wanted to return item in the list when emptying, you'd have to
        # save items in a temp variable and return that variable after running
        # the line below.
